 ...
 */
@Serializable
open class SubactivityReference(
    val deliveryTime: Date,
    val description: String,
    val status: String,
    val url: Uri) {

    @Serializer(forClass = SubactivityReference::class)
    companion object : INetwork<SubactivityReference> {
        override val descriptor: SerialDescriptor = SerialDescriptor("SubactivityReference") {
        ...
        override fun serialize(encoder: Encoder, value: SubactivityReference) {
        ...
        override fun deserialize(decoder: Decoder): SubactivityReference {
